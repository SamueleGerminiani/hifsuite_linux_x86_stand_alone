...
void spec2::hif_cone__24__1()
{
    _25_ = muffin::inject( hif_fault_node.instance, 0ULL, 1ULL, !(*hif_a2t_data.b_3
            ) );
    _13_ = muffin::inject( hif_fault_node.instance, 1ULL, 1ULL, !(*hif_a2t_data.a_3
            ) );
    _30_ = muffin::inject( hif_fault_node.instance, 2ULL, 1ULL, !_37_ );
    _31_ = muffin::inject( hif_fault_node.instance, 3ULL, 1ULL, !(*hif_a2t_data.c_3
            ) );
    _16_ = muffin::inject( hif_fault_node.instance, 4ULL, 1ULL, _37_ && *hif_a2t_data.c_3
         );
    _08_ = muffin::inject( hif_fault_node.instance, 5ULL, 1ULL, _30_ && *hif_a2t_data.c_3
         );
    _05_ = muffin::inject( hif_fault_node.instance, 6ULL, 1ULL, _13_ && *hif_a2t_data.b_3
         );
    _35_ = muffin::inject( hif_fault_node.instance, 7ULL, 1ULL, _25_ && *hif_a2t_data.a_3
         );
    ...
    _17_ = muffin::inject( hif_fault_node.instance, 10ULL, 1ULL, _16_ && *hif_a2t_data.a_3
         );
    ...
    _33_ = muffin::inject( hif_fault_node.instance, 19ULL, 1ULL, _32_ && *hif_a2t_data.a_3
         );
...
void spec2::hif_cone__29_()
{
    _13_ = muffin::inject( hif_fault_node.instance, 28ULL, 1ULL, !(*hif_a2t_data.a_3
            ) );
    _30_ = muffin::inject( hif_fault_node.instance, 29ULL, 1ULL, !_37_ );
    _31_ = muffin::inject( hif_fault_node.instance, 30ULL, 1ULL, !(*hif_a2t_data.c_3
            ) );
    _08_ = muffin::inject( hif_fault_node.instance, 31ULL, 1ULL, _30_ && *hif_a2t_data.c_3
         );
    _05_ = muffin::inject( hif_fault_node.instance, 32ULL, 1ULL, _13_ && *hif_a2t_data.b_3
         );
    _36_ = muffin::inject( hif_fault_node.instance, 33ULL, 1ULL, _31_ && _37_ );
    _02_ = muffin::inject( hif_fault_node.instance, 34ULL, 1ULL, *hif_a2t_data.a_3
             && *hif_a2t_data.b_3 );
...
spec2::spec2() :
    ...
    flag_process_3_process_4_executed(false),
...
void spec2::process_3_process_4()
{
    hif_cone__24__1();
    _37__new = muffin::inject( hif_fault_node.instance, 47ULL, 1ULL, _24_ );
    hif_cone__29_();
    *hif_a2t_data.c_3 = muffin::inject( hif_fault_node.instance, 48ULL, 1ULL, _29_
         );
}
...
void spec2::flag_elaboration()
{
    ...
    {
        process_3_process_4();
        flag_process_3_process_4_executed = true;
    }
}
